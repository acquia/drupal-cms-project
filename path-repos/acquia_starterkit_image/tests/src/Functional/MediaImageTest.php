...
/**
 * Tests the Acquia Starter Kit Image media type recipe.
 *
...
class MediaImageTest extends BrowserTestBase {
  ...
  /**
   * Verify the Image media type by adding media.
   */
  public function testImage(): void {
    ...
    $group = $assert_session->elementExists('css', '#edit-field-media-image-wrapper');
    $assert_session->fieldExists('files[field_media_image_0]', $group);
