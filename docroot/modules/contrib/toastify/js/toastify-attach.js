...
(function () {
  ...
  Drupal.toastify.getDefaultSettings = function (type) {
    const displaySettings = drupalSettings.toastify.settings;
    ...
    return {
      ...
      style: {
        background: `linear-gradient(${displaySettings[type].direction}, ${
          displaySettings[type].color
        }, ${displaySettings[type].color2})`,
      ...
      offset: {
        x: displaySettings[type].offsetX,
        y: displaySettings[type].offsetY,
      },
    };
  };
