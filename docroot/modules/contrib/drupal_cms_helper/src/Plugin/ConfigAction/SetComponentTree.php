...
final class SetComponentTree implements ConfigActionPluginInterface, ContainerFactoryPluginInterface {
  ...
  public function apply(string $configName, mixed $value): void {
    ...
    $this->setComponentVersions($value);
    // @phpstan-ignore-next-line
    $entity->setComponentTree($value)->save();
  }

  /**
   * Walks a component tree and sets component versions where they're missing.
   *
   * @param array<int, array<mixed>> $tree
   *   A component tree.
   */
  public function setComponentVersions(array &$tree): void {
    ...
    foreach ($tree as &$item) {
      assert(array_key_exists('component_id', $item));
      ...
      $item['component_version'] = $component->getActiveVersion();
    }
  }
