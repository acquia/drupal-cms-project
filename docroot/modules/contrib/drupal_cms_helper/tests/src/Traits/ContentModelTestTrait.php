...
trait ContentModelTestTrait {
  ...
  /**
   * Asserts that a content type is configured a certain way.
   *
   * @param array $content_model
   *   An array of arrays, keyed by content type machine name. Each inner array
   *   is an array of arrays, keyed by field name, and each of *those* arrays
   *   describes a field instance:
   *   - `type`: The field type.
   *   - `cardinality`: The field's cardinality.
   *   - `required`: Whether the field instance is required.
   *   - `translatable`: Whether the field instance is translatable.
   *   - `label`: The field instance's human-readable label.
   *   - `input type`: The type of widget used for this field instance.
   *   - `help text`: The help text, if any, for this field instance.
   */
