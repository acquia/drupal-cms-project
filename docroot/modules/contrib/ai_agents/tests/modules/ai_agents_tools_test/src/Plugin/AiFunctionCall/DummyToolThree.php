...
/**
 * A third test AI function call that echoes back its input string.
 */
#[FunctionCall(
  id: 'ai_agents_tools_test:dummy_tool_three',
  function_name: 'dummy_tool_three',
  name: 'Dummy Tool Three',
...
class DummyToolThree extends FunctionCallBase implements ExecutableFunctionCallInterface {
