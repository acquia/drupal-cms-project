...
Adds integration with AI services, such as alt text generation and a chat bot to assist with site building. You can choose from several providers: amazee.ai, OpenAI or Anthropic.
...
- [amazee.ai AI Provider](https://www.drupal.org/project/ai_provider_amazeeio)
